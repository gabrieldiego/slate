...
SLATE_LOCAL_CACHE_HOME ?= $(CURDIR)/target/cache
SLATE_LOCAL_XDG_CACHE_HOME ?= $(SLATE_LOCAL_CACHE_HOME)/xdg
SLATE_LOCAL_UV_CACHE_DIR ?= $(SLATE_LOCAL_CACHE_HOME)/uv
SLATE_LOCAL_RUST_ENV := RUSTUP_HOME="$(SLATE_LOCAL_RUSTUP_HOME)" CARGO_HOME="$(SLATE_LOCAL_CARGO_HOME)" XDG_CACHE_HOME="$(SLATE_LOCAL_XDG_CACHE_HOME)" UV_CACHE_DIR="$(SLATE_LOCAL_UV_CACHE_DIR)"
