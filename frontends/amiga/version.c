 ...
 */
#define SLATE_VERSION_MAJOR "3"
#define SLATE_VERSION_MINOR_EXTERNAL "12"
#if defined(CI_BUILD)
#define SLATE_VERSION_MINOR SLATE_VERSION_MINOR_EXTERNAL "0" CI_BUILD
#else
#define SLATE_VERSION_MINOR SLATE_VERSION_MINOR_EXTERNAL "99999"
#endif

static const __attribute__((used)) char *verstag = "\0$VER: NetSurf " SLATE_VERSION_MAJOR "." SLATE_VERSION_MINOR " (" WT_COMPILEDATE ")\0";
const char * const verdate = WT_COMPILEDATE;
const char * const verarexx = SLATE_VERSION_MAJOR "." SLATE_VERSION_MINOR_EXTERNAL;
