...
struct ami_corewindow {
		 ...
		 */
		slateerror (*draw)(struct ami_corewindow *ami_cw, int x, int y, struct rect *r,
		 ...
		 */
		slateerror (*key)(struct ami_corewindow *ami_cw, uint32_t nskey);
		 ...
		 */
		slateerror (*mouse)(struct ami_corewindow *ami_cw, browser_mouse_state mouse_state, int x, int y);
		 ...
		 * \return SLATEERROR_OK on success otherwise apropriate error code
		 */
		slateerror (*drag_end)(struct ami_corewindow *ami_cw, int x, int y);
		 ...
		 * \return SLATEERROR_OK on success otherwise apropriate error code
		 */
		slateerror (*icon_drop)(struct ami_corewindow *ami_cw, struct slateurl *url, const char *title, int x, int y);
