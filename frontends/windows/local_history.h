...
/**
 * \file
 * Interface to win32 local history manager using slatew32 core window
 */

#ifndef SLATE_WINDOWS_LOCAL_HISTORY_H
#define SLATE_WINDOWS_LOCAL_HISTORY_H
 ...
 */
slateerror slatew32_local_history_present(HWND hWndParent, struct browser_window *bw);
