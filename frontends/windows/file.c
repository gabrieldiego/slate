 ...
 */
static slateerror windows_mkpath(char **str, size_t *size, size_t nelm, va_list ap)
{
 ...
 *         or error code on faliure.
 */
static slateerror windows_basename(const char *path, char **str, size_t *size)
{
	const char *leafname;
	char *fname;
...
/**
 * Create a path from a slateurl using windows file handling.
 *
 ...
 *         on faliure.
 */
static slateerror windows_slateurl_to_path(struct slateurl *url, char **path_out)
{
	lwc_string *urlpath;
	char *path;
	bool match;
...
/**
 * Create a slateurl from a path using windows file handling.
 *
 ...
 *         faliure.
 */
static slateerror windows_path_to_slateurl(const char *path, struct slateurl **url_out)
{
	slateerror ret;
	int urllen;
	char *urlstr;
 ...
 */
static slateerror windows_mkdir_all(const char *fname)
{
	char *dname;
	char *sep;
	struct stat sb;
...
static struct gui_file_table file_table = {
	...
	.slateurl_to_path = windows_slateurl_to_path,
	.path_to_slateurl = windows_path_to_slateurl,
