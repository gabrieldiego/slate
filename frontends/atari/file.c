 ...
 */
static slateerror atari_mkpath(char **str, size_t *size, size_t nelm, va_list ap)
{
 ...
 *         or error code on faliure.
 */
static slateerror atari_basename(const char *path, char **str, size_t *size)
{
	const char *leafname;
	char *fname;
...
/**
 * Create a path from a slateurl using GEMDOS file handling.
 *
 ...
 *         on faliure.
 */
static slateerror atari_slateurl_to_path(struct slateurl *url, char **path_out)
{
	lwc_string *urlpath;
	size_t path_len;
	char *path;
...
/**
 * Create a slateurl from a path using GEMDOS file handling.
 *
 ...
 *         faliure.
 */
static slateerror atari_path_to_slateurl(const char *path, struct slateurl **url_out)
{
	slateerror ret;
	int urllen;
	char *urlstr;
 ...
 */
static slateerror atari_mkdir_all(const char *fname)
{
	char *dname;
	char *sep;
	struct stat sb;
...
static struct gui_file_table file_table = {
	...
	.slateurl_to_path = atari_slateurl_to_path,
	.path_to_slateurl = atari_path_to_slateurl,
