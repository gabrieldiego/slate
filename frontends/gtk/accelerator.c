...
slateerror slategtk_accelerator_init(char **respaths)
{
	slateerror res;
	const uint8_t *data;
	size_t data_size;
...
const char *slategtk_accelerator_get_desc(const char *key)
{
	if ((key == NULL) ||
