...
#ifndef _SLATE_GTK_VIEWDATA_H_
#define _SLATE_GTK_VIEWDATA_H_
 ...
 */
slateerror slategtk_viewdata(const char *title, const char *filename, char *data, size_t data_size);
 ...
 */
slateerror slategtk_viewfile(const char *title, const char *leafname, const char *filename);
