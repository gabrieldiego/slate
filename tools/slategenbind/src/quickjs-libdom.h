...
#ifndef slategenbind_slatejs_libdom_h
#define slategenbind_slatejs_libdom_h

/**
 * Generate output for quickjs and libdom bindings.
 */
...
/**
 * generate a source file to implement a dictionary using QuickJS and libdom.
 */
int output_dictionary(struct ir *ir, struct ir_entry *dictionarye);

/**
 * generate a declaration to implement a dictionary using QuickJS and libdom.
 */
...
/**
 * generate preface block for slategenbind
 */
