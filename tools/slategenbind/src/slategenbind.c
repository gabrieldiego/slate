...
static enum bindingtype_e genbind_get_type(struct genbind_node *node)
{
        ...
        if (strcmp(binding_type, "slatejs_libdom") == 0) {
                return BINDINGTYPE_SLATEJS_LIBDOM;
        }
...
int main(int argc, char **argv)
{
	...
	/* debug dump of web idl AST */
        ...
        /* generate binding */
        switch (bindingtype) {
        case BINDINGTYPE_SLATEJS_LIBDOM:
                res = slatejs_libdom_output(ir);
                break;
