...
#define SLATEGENBIND_PREFACE                                            \
    "/* Generated by slategenbind\n"                                    \
    " *\n"                                                              \
    " * slategenbind is published under the MIT Licence.\n"             \
    " * slategenbind is similar to a compiler is a purely transformative tool which\n" \
...
{
        outputf(outc, "%s", SLATEGENBIND_PREFACE);
