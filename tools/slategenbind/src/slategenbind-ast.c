...
extern int slategenbind_debug;
extern int slategenbind__flex_debug;
extern void slategenbind_restart(FILE*);
extern int slategenbind_parse(char *filename, struct genbind_node **genbind_ast);
...
/* exported interface defined in slategenbind-ast.h */
int
...
/* exported interface documented in slategenbind-ast.h */
struct genbind_node *
...
int genbind_parsefile(char *infilename, struct genbind_node **ast)
{
        ...
        if (options->debug) {
                slategenbind_debug = 1;
                slategenbind__flex_debug = 1;
        ...
        slategenbind_restart(infile);

        /* process binding */
        ret = slategenbind_parse(infilename, ast);
