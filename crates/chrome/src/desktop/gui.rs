...
mod tests {
    ...
    use super::{
        ...
        FOOTER_SETTINGS_BUTTON_SIZE, FOOTER_SYNC_DOT_SIZE, FOOTER_TEXT_SIZE, HOME_HERO_SIZE,
        HOME_HERO_TO_SEARCH_GAP, HOME_METRIC_BADGE_MARGIN_X, HOME_METRIC_BADGE_MARGIN_Y,
        ...
        HOME_METRIC_ICON_LABEL_GAP, HOME_METRIC_ICON_SIZE, HOME_SEARCH_ICON_SIZE,
