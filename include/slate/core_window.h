...
#ifndef _SLATE_CORE_WINDOW_H_
#define _SLATE_CORE_WINDOW_H_
...
struct core_window_table {
	 ...
	 */
	slateerror (*invalidate)(struct core_window *cw, const struct rect *rect);
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code
	 */
	slateerror (*set_extent)(struct core_window *cw, int width, int height);
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code
	 */
	slateerror (*set_scroll)(struct core_window *cw, int x, int y);
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code
	 */
	slateerror (*get_scroll)(const struct core_window *cw, int *x, int *y);
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code
	 */
	slateerror (*get_dimensions)(const struct core_window *cw,
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code
	 */
	slateerror (*drag_status)(struct core_window *cw,
