...
#ifndef _SLATE_URL_DB_H_
#define _SLATE_URL_DB_H_
 ...
 */
void urldb_iterate_partial(const char *prefix, bool (*callback)(struct slateurl *url, const struct url_data *data));
 ...
 */
void urldb_iterate_entries(bool (*callback)(struct slateurl *url,	const struct url_data *data));
 ...
 */
const struct url_data *urldb_get_url_data(struct slateurl *url);
 ...
 */
void urldb_set_cert_permissions(struct slateurl *url, bool permit);
