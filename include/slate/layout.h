...
#ifndef _SLATE_LAYOUT_H_
#define _SLATE_LAYOUT_H_
...
struct gui_layout_table
{
	 ...
	 *          code on faliure
	 */
	slateerror (*width)(const struct plot_font_style *fstyle, const char *string, size_t length, int *width);
	 ...
	 */
	slateerror (*position)(const struct plot_font_style *fstyle, const char *string, size_t length, int x, size_t *char_offset, int *actual_x);
	 ...
	 */
	slateerror (*split)(const struct plot_font_style *fstyle, const char *string, size_t length, int x, size_t *char_offset, int *actual_x);
};
