...
#ifndef _SLATE_UTF8_H_
#define _SLATE_UTF8_H_
...
struct gui_utf8_table {
	 ...
	 */
	slateerror (*utf8_to_local)(const char *string, size_t len, char **result);
	 ...
	 * \return An slateerror code
	 */
	slateerror (*local_to_utf8)(const char *string, size_t len, char **result);
};
