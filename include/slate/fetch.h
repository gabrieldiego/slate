...
#ifndef _SLATE_FETCH_H_
#define _SLATE_FETCH_H_
...
struct gui_fetch_table {
	 ...
	 */
	struct slateurl* (*get_resource_url)(const char *path);
	 ...
	 */
	slateerror (*get_resource_data)(const char *path, const uint8_t **data, size_t *data_len);
	 ...
	 */
	slateerror (*release_resource_data)(const uint8_t *data);
