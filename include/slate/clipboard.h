...
#ifndef _SLATE_CLIPBOARD_H_
#define _SLATE_CLIPBOARD_H_
...
struct gui_clipboard_table {
	 ...
	 */
	void (*set)(const char *buffer, size_t length, slateclipboard_styles styles[], int n_styles);
};
