...
#ifndef SLATE_WINDOW_H
#define SLATE_WINDOW_H
...
struct gui_window_table {
	 ...
	 */
	slateerror (*invalidate)(struct gui_window *gw, const struct rect *rect);
	 ...
	 * \return SLATEERROR_OK on success or appropriate error code.
	 */
	slateerror (*set_scroll)(struct gui_window *gw, const struct rect *rect);
	 ...
	 *          else error code.
	 */
	slateerror (*get_dimensions)(struct gui_window *gw, int *width, int *height);
	 ...
	 */
	slateerror (*event)(struct gui_window *gw, enum gui_window_event event);
	 ...
	 */
	slateerror (*set_url)(struct gui_window *gw, struct slateurl *url);
	 ...
	 */
	slateerror (*save_link)(struct gui_window *g, struct slateurl *url, const char *title);
