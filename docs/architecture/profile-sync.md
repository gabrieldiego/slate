...
and Files deletions, so apps can observe decoded deletion payloads and only
then acknowledge the tail revision.
...
Chat, Contacts, Downloads, Files, and Storage, and Chat/Downloads/Files
